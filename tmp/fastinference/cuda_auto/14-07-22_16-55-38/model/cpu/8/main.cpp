...
int main (int argc, char *argv[]) {
	...
	// TODO: folder needs to be "tmp/fastinference/cuda_auto/model_39252895_4357_29793882/profiles"
	// but cannot access name of folder from here -> add to cmake? or leave it outside
