...
def to_implementation(model, out_path, out_name, weight = 1.0, align = 0, namespace = "FAST_INFERENCE", feature_type = "double", label_type = "double", internal_type = "double", **kwargs):
    """
    Generates a C++ implementation of the given NeuralNet model. 
    This implementation provides a NHWC layout for the convolution layers basically resulting in a structure like this:
