...
int main (int argc, char *argv[]) {
	...
	if(!std::experimental::filesystem::exists(std::string("profiles/") + IMPL)){
		std::experimental::filesystem::create_directories(std::string("profiles/") + IMPL);
	}
